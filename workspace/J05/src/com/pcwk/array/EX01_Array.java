...
public class EX01_Array {
	...
	public static void main(String[] args) {
		...
		System.out.println("studentId[0] : "+studentId[0]); // studentId[0] : 101
		System.out.println("studentId[1] : "+studentId[1]); // studentId[1] : 102

		int add = studentId[0] + studentId[1]; // 101 + 102
		System.out.println("add="+add); // add=203
		
		System.out.println("배열길이: "+studentId.length); // 배열길이: 3
