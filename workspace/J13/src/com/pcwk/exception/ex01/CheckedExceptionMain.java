...
public class CheckedExceptionMain implements LoggerManager {
	...
	public static void main(String[] args) {
		...
		try {
			// C:\DCOM_20220127\01_JAVA\workspace\J13\src\com\pcwk\exception\ex01\CheckedExceptionMain.java (이 경로를 쓰면 오류가 안남)
			...
			// getMessage() : 발생한 예외클래스의 인스턴스에 저장된 메시지를 얻을 수 있다.(요약본 느낌)
