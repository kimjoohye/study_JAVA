...
public class NaverSearchEx01 {
	...
	public static void main(String[] args) {
		String clientId="VIabv4edo56F93HDcuAk"; // 클라이언트 아이디
		String clientSecret = "1QJ4gEHoOm";		// 클라이언트 시크릿
